...
public class Board extends JPanel {
  ...
  private String message = "Time's Up";
  ...
  private void gameInit() {
    ...
    for (int i = 0; i < Utils.NUMBER_OF_CARS; i++) {
      ...
      cars[i] = new Car(pos, Utils.INIT_CAR_Y + i * Utils.CAR_HEIGHT + 40, "carro-" + i + ".png", direction, carSpeed);
  ...
  private void gameFinished(Graphics2D g2d){
    ...
    FontMetrics mtrs = getFontMetrics(font);
    g2d.setColor(Color.BLACK);
    g2d.setFont(font);
    g2d.drawString(message, Utils.WIDTH - mtrs.stringWidth(message)/2, Utils.HEIGHT/2);
  }
